...
namespace ATM.ClassLibrary.Classes
{
    public class Session
    {
        ...
        EventHandler<CheckBalanceEventArgs>
       checkBalanceEvent,
        ...
        public void SetCheckBalanceHandler(EventHandler<CheckBalanceEventArgs>
       checkBalanceEvent)
        {
            CheckBalanceEvent += checkBalanceEvent;
        }
        ...
        public void RemoveAuthorizeHandler(EventHandler<AuthorizeEventArgs>
       authorizeEvent)
        {
            AuthorizeEvent -= authorizeEvent;
        }
        public void RemoveCheckBalanceHandler(EventHandler<CheckBalanceEventArgs>
       checkBalanceEvent)
        {
            CheckBalanceEvent -= checkBalanceEvent;
        }
        ...
        public void RemoveAccountHandlers(EventHandler<AuthorizeEventArgs>
       authorizeEvent,
        EventHandler<CheckBalanceEventArgs>
       checkBalanceEvent,
       EventHandler<AccountEventArgs> putEvent,
        ...
        protected void OnAuthorizeEvent(bool success)
        {
            if (AuthorizeEvent != null)
                AuthorizeEvent(this, new AuthorizeEventArgs(Account.FullName,
               Account.CardNumber, success));
        }
        ...
        protected void OnCheckBalanceEvent(int balance)
        {
            if (CheckBalanceEvent != null)
                CheckBalanceEvent(this, new CheckBalanceEventArgs(Account.FullName,
               Account.CardNumber, balance));
        }
        ...
        {
            if (PutEvent != null)
                PutEvent(this, new AccountEventArgs(Account.FullName,
               Account.CardNumber));
        }
        ...
        protected void OnWithdrawEvent(int amount, bool atmCashLack, bool
       accountBalanceLack)
        {
            if (WithdrawEvent != null)
                WithdrawEvent(this, new WithdrawEventArgs(Account.FullName,
               Account.CardNumber, atmCashLack, accountBalanceLack));
        }
        ...
        protected void OnTransferEvent(string recipient, int sum, bool
       accountBalanceLack, bool recipientDoesntExist)
        {
            if (TransferEvent != null)
                TransferEvent(this, new TransferEventArgs(Account.FullName,
               Account.CardNumber,
